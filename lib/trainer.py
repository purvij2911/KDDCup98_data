...
class Trainer:
    ...
    def train_model(df,target):
       ...
       #Split the data into training and test set
        ...
        train_bal, y_train_bal = undersample.fit_resample(X_train, y_train)
        ...
        all_models = {'UNDERSAMPLE Logistic Regression Model': perf_model1,
                      'UNDERSAMPLE Decision Trees Model': perf_model2,
                      'UNDERSAMPLE Random Forest Model': perf_model3,
                      'UNDERSAMPLE XGBoost':perf_model4,
                      'ADASYN Logistic Regression Model': perf_model6,
                      'ADASYN Decision Trees Model': perf_model7,
                      'ADASYN Random Forest Model': perf_model5,
        ...
        result = pd.DataFrame.from_dict(all_models,
